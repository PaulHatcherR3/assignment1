...
public class TPMFlow {
    ...
    public static class Create extends FlowLogic<SignedTransaction> {
        ...
        public Create(Party otherParty, String createHint, String gameId) {
    ...
    public static class CreateAcceptor extends FlowLogic<SignedTransaction> {

        private final FlowSession otherPartySession;

        public CreateAcceptor(FlowSession otherPartySession) {
    ...
    @InitiatingFlow
    @StartableByRPC
    public static class Move extends FlowLogic<SignedTransaction> {
        ...
        public Move(String gameId,String moveHint, int src, int dst) {
            this.gameId = gameId;
    ...
    // This is the receiving party side for the above.
    @InitiatedBy(Move.class)
    public static class MoveAcceptor extends FlowLogic<SignedTransaction> {

        private final FlowSession otherPartySession;

        public MoveAcceptor(FlowSession otherPartySession) {
            this.otherPartySession = otherPartySession;
        }
